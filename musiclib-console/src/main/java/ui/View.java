...
import company.entityclass.role.AdminRole;
import company.entityclass.role.ArtistRole;
import company.entityclass.role.Role;
import company.entityclass.role.UserRole;
...
public class View {
    public void start() {
        ...
        try (final DBStorage controller = DBStorage.getInstance()) {
            while (access == 0) {
